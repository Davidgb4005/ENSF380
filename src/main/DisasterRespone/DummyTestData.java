package Test; // Added a package declaration for better organization
...
public class DummyTestData {
    ...
    // 1. Static People Data
    public static final Vector<PersonData> PEOPLE = new Vector<>(List.of(
    ...
    public static final Vector<LocationData> LOCATIONS = new Vector<>(List.of(
